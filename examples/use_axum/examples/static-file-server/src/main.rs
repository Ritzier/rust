...
fn using_serve_dir_with_assets_fallback() -> Router {
    ...
    // so with this `GET /assets/doesnot-exist.jpg` will return `index.html`
    // rather than a 404
...
fn using_serve_dir_with_handler_as_service() -> Router {
    async fn handle_404() -> (StatusCode, &'static str) {
        (StatusCode::NOT_FOUND, "Not foudn")
    }

    // you can convert handler function to srevice
...
fn two_serve_dirs() -> Router {
    // you can also have two `ServeDir`s nested at different parths
