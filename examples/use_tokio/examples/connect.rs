...
mod tcp {
    ...
    pub async fn connect(
        ...
        // filter map Result<Bytes, Error> stream into just a Bytes stream to match stdout Sink
        ...
        let mut stream = FramedRead::new(r, BytesCodec::new())
            .filter_map(|i| match i {
                ...
                Err(e) => {
                    println!("faield to read from socket; error={}", e);
                    future::ready(None)
                }
            })
            .map(Ok);
...
mod udp {
    ...
    pub async fn connect(
        ...
        // basically let the OS pick of those.
