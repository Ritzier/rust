                ...
                if (oldText.startsWith("bo") && newText !== oldText) {
                    ...
                    while (oldBranches > 0 && newBranches > 0) {
                        if (
                            ...
                            console.log(
                                oldDocWalker.currentNode,
                                newDocWalker.currentNode,
                            );
                            if (
                                oldDocWalker.currentNode.nodeType ===
                                Node.COMMENT_NODE
                            ) {
                                if (
                                    oldDocWalker.currentNode.textContent.startsWith(
                                        "bo",
                                    )
                                ) {
                                    oldBranches += 1;
                            ...
                            if (
                                newDocWalker.currentNode.nodeType ===
                                Node.COMMENT_NODE
                            ) {
                                if (
                                    newDocWalker.currentNode.textContent.startsWith(
                                        "bo",
                                    )
                                ) {
                                    newBranches += 1;
                    ...
                    try {
                        ...
                        oldNode.replaceWith(newNode);
                        oldDocWalker.currentNode.replaceWith(
                            newDocWalker.currentNode,
                        );
                    } catch (e) {
                        console.error(e);
